 ...
 */
package com.dbeaver.osgi.resolvers;
...
public class DynamicImportsResolver {
    ...
    private final Set<String> excludedBundles = Set.of("org.eclipse.rap.rwt");
    @Nullable
    private final IImportListener importListener;

    public DynamicImportsResolver(@org.jkiss.code.Nullable IImportListener importListener) {
    ...
    private void resolveImportPackages(
        ...
        for (var packageToImport : bundleInfo.getImportPackages()) {
                ...
                if (!suitableParsedBundles.isEmpty()) {
                    for (Pair<BundleInfo, Version> info : suitableParsedBundles) {
                        ...
                        if (importListener != null) {
                            importListener.notifyAboutDependency(packageToImport, info);
                        }
                    }
                }
            ...
            eclipseBundlesWithThisPackage.forEach(it -> {
                ...
                if (importListener != null) {
                    importListener.notifyAboutDependency(packageToImport, it);
                }
            });
