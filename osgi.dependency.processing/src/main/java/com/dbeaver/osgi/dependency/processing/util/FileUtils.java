...
//        "com.google.guava",
    ...
    @Nullable
    public static File findFirstChildByPackageName(@NotNull Path folder, @NotNull String packageName) {
    ...
    @Nullable
    public static File findFirstChildByPackageName(@NotNull File folder, @NotNull String packageName) {
    ...
    private static File getMaxVersion(@NotNull File[] files, @NotNull String packageName) {
    ...
    public static @NotNull Version extractVersion(@NotNull File file) {
        return new Version(StringUtils.substringAfterLast(file.getName(), NAME_AND_VERSION_SEPARATOR));
    }

    public static @NotNull Properties readPropertiesFile(@NotNull Path path) throws IOException {
    ...
    public static void writePropertiesFile(@NotNull Path path, @NotNull Map<String, String> properties)
        throws IOException {
    ...
    public static void storeProperties(BufferedWriter bw, String comments, @NotNull Map<String, String> properties) {
        try {
            if (comments != null) {
                bw.write("#" + comments);
            }
    ...
    public static void removeAllFromDir(@NotNull Path targetPath) throws IOException {
